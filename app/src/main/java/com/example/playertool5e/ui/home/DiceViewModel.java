...
public class DiceViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<Integer> diceAmount;
    private MutableLiveData<Integer> rollBonus;
    ...
    public void deleteDice(long id){
        MainActivity.executor.execute(() -> {db.allDao().deleteDie(id);});
    }
    ...
    public MutableLiveData<Integer> getThreshold(){return threshold;}
    ...
    public void setThreshold(Integer integer){threshold.setValue(integer);}
}